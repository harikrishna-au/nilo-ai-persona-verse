...
const Footer = () => {
  return (
    <footer id="contact" className="bg-secondary/60 py-12">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            ...
            <p className="text-muted-foreground max-w-xs mb-6">
              Next-generation AI avatars delivering personalized, intelligent support for businesses across industries.
            </p>
        ...
        <div className="mt-12 border-t border-border/30 pt-8">
          <p className="text-center text-sm text-muted-foreground">
            &copy; {new Date().getFullYear()} Nilo AI. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
