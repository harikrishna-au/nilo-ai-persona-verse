...
const Navbar = () => {
  return (
    <nav className="border-b border-amber-200/20 backdrop-blur-md bg-background/80 fixed top-0 left-0 right-0 z-50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
          <div className="flex-shrink-0 flex items-center">
            <Link to="/" className="flex items-center">
              <span className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-amber-700 to-amber-500">
                Nilo AI
              </span>
            </Link>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <a href="#technology" className="text-sm font-medium text-foreground/80 hover:text-primary transition-colors">
              Technology
            </a>
